import{f as m,r,j as e}from"./react-vendor-9OMi5S6e.js";import{r as g}from"./index-DFTywMxZ.js";import"./net-BOeqtr82.js";import"./socket-dm1FmSOd.js";const a={name:"SECURED ENGINEERS PVT. LTD.",head:"B.K Towers, Janta Nagar, Gill Road, Ludhiana, (PB) 141003",corp:"58/A/1, First Floor, Kalu Sarai, New Delhi - 110016",email:"Sales@securedengineers.com",website:"www.securedengineers.com"};function u(){const{id:l}=m(),[d,x]=r.useState(null),[o,p]=r.useState(null);if(r.useEffect(()=>{g.get(`/procurement/indents/${l}/print`).then(s=>x(s.data)).catch(s=>{var t,c;return p(((c=(t=s.response)==null?void 0:t.data)==null?void 0:c.error)||"Failed to load")})},[l]),o)return e.jsx("div",{className:"p-8 text-red-600",children:o});if(!d)return e.jsx("div",{className:"p-8 text-gray-400",children:"Loading…"});const i=d.indent,n=d.items||[],h=s=>{if(!s)return"—";const t=new Date(s);return isNaN(t)?s:`${String(t.getDate()).padStart(2,"0")}/${String(t.getMonth()+1).padStart(2,"0")}/${t.getFullYear()}`};return e.jsxs("div",{className:"bg-white min-h-screen",children:[e.jsx("style",{children:`
        @media print {
