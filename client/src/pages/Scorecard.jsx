...
const SOURCE_INFO = {
  ...
  'auto:snags':                  { plan: 'Snags standing assigned to user this week (old open + new)', actual: 'Assigned snags approved (closed) within the week' },
  ...
  'auto:snags_all':             { plan: 'ALL open snags this week (company-wide, old + new)', actual: 'ALL snags approved (closed) within the week (company-wide)' },
