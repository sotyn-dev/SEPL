...
const SOURCE_INFO = {
  ...
  'auto:snags':                  { plan: 'Snags assigned to user',            actual: 'Snags approved (closed) by user' },
  ...
  'auto:snags_all':             { plan: 'ALL snags raised this week (company-wide)', actual: 'ALL snags approved (closed) this week (company-wide)' },
