...
export const DESIGNATIONS = [
  ...
  { role: 'Finance Executive', who: 'Aanchal', fam: 'Finance', w: [12, 20, 16, 32],
    m: [['Payment requests processed', '= queue / wk', '/payment-required'], ['Reconciliation accuracy (no disputes)', '≥98%', '/cash-flow-tracker'], ['Expense approval turnaround', '≤48 h', '/expenses'], ['Overdue recovery + expense control ₹', 'recovery ↑', '/collections']] },
  { role: 'Cash Flow Manager', who: 'GAP — Parul Goyal mis-assigned here', fam: 'Finance', w: [12, 20, 16, 32],
    m: [['Invoices raised', '= billable milestones', '/billing'], ['Billing accuracy (no credit notes)', '≥98%', '/billing'], ['Bill within 24 h of milestone', '≥90%', '/installation'], ['DSO (collections)', '≤60 days', '/cash-flow-tracker']] },
  ...
  { role: 'Compliance & Tender', who: 'GAP — reassign Parul Goyal here', fam: 'Estimation', w: [16, 24, 16, 24],
    m: [['Tenders submitted', '= live tenders / wk', '/quotations'], ['Compliance docs complete (no rejection)', '≥95%', '/fire-noc'], ['Fire-NOC + statutory renewals before due', '100%', '/fire-noc'], ['Bad-debt / litigation ₹ avoided-recovered', '↑', '/cash-flow-tracker']] },
