// India states + districts for cascading dropdowns. Static reference
// data — kept in the client so dropdowns are instant without a network
// round-trip. Districts are the major ones per state (covers >95% of
// MEPF project locations); the form also accepts free-typing in case
// a recently-created district isn't in this list yet.
...
export const DISTRICTS_BY_STATE = {
  ...
  'Chhattisgarh': [
    ...
    'Kanker', 'Kondagaon', 'Korba', 'Korea', 'Mahasamund', 'Mungeli',
    'Narayanpur', 'Raigarh', 'Raipur', 'Rajnandgaon', 'Sukma', 'Surajpur',
    'Surguja', 'Manendragarh-Chirmiri-Bharatpur', 'Mohla-Manpur-Ambagarh Chowki',
  ...
  'Madhya Pradesh': [
    ...
    'Dewas', 'Dhar', 'Dindori', 'Guna', 'Gwalior', 'Harda', 'Hoshangabad',
  ...
  'Rajasthan': [
    ...
    'Khairthal-Tijara', 'Kotputli-Behror', 'Kota', 'Nagaur', 'Neem Ka Thana', 'Pali',
    'Phalodi', 'Pratapgarh', 'Rajsamand', 'Salumber', 'Sanchore', 'Sawai Madhopur',
...
// Common subcontractor types for MEPF projects — keep this short and
// curated so mam's team picks from a stable taxonomy. "Other" is the
